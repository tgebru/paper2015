...
%\fbox{\rule{0pt}{2in} \rule{0.9\linewidth}{0pt}}
    ...
    \includegraphics[width=0.23\linewidth]{img/years1990-1994Income.png}
    \includegraphics[width=0.23\linewidth]{img/years1995-1999Income.png}
    \includegraphics[width=0.23\linewidth]{img/years2000-2004Income.png}
    \includegraphics[width=0.23\linewidth]{img/years2005-2009Income.png}  
\end{center}
   \caption {(A) Countries of cars w.r.t. median household income, (B) years of cars w.r.t. median household income}
